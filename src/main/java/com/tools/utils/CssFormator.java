...
/**
 * copy from yahoo.platform.yui.compressor.CssCompressor
 * modified the compress method
 *
 */
public class CssFormator {
    ...
    public CssFormator(Reader in) throws IOException {
        // Read the stream...
        int c;
        while ((c = in.read()) != -1) {
            srcsb.append((char) c);
