...
public class PrefoxEmailTemp {
    ...
    public String buildHtmlMsg(String call,String summary,String msg) {
        return html.replaceAll("prefox.official.website", prefox_offical_website)
                .replace("profox.email.content", msg)
