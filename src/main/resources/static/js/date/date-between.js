$(function () {
    ...
    calculate = $("#calculate");
    $(startYear, endYear).keyup(function (event) {
        detectYear(event.delegateTarget);
    });
    $(startMonth, endMonth).keyup(function (event) {
        detectMonth(event.delegateTarget);
    });
    $(startday, endday).keyup(function (event) {
        detectDay(event.delegateTarget);
    });
