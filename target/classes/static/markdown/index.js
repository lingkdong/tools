...
function markdownToPdf(){
    ...
    $.ajax({
        type: "post",
        url: PRE_FOX_ANON_BASE+"/markdown/store-pdf.json",
        async: true,
        dataType: "json",
        data: {
            name: name,
        ...
        success: function (result) {
            ...
            {
                window.location.href=PRE_FOX_ANON_BASE+"/markdown/get-pdf.html?token="+result.data;
            }
        },
        error: function (result) {
            swal("Error", "服务器错误请稍后再试", "error");
        },
        complete: function () {
            $("#menu").hide();
        }
